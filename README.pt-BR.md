...
Segue o princípio de que a solução mais simples é a melhor solução, em que o sistema e diretórios resultantes (exceto imagens) ocupam tão pouco armazenamento ao ponto de caber em um disquete, ou ate mesmo um cartucho de NES, multiplas vezes.
